...
#End Region
  ...
  Sub SubDruck(ByRef FaObs As Integer, ByRef UserID As Integer, ByRef MethID As Integer, ByRef Messg As MeasParameters, ByRef FarbTable As DataTable)
    ...
    Select Case DruckSelected
      Case 1  'Freigabeprotokoll Standard
        ...
        Fawrt = 0
        Verweis = GetPrivSettings("MANKIEWICZ", "VERWEIS", "-nur für internen Gebrauch-", COLORFileName())
  ...
  Sub RenderFarb()
    ...
    With ReportFarbMaster.Sections(SectionTypeEnum.Header)
      ...
      '
      '
      f = .Fields.Add("Man000", Verweis, 0.5 * Margin, 1440 - 3.6 * MerkHeight, 0.5 * WholeWidth, 1.3 * MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 16
      f.Font.Bold = True
      ...
      '
      '
      f = .Fields.Add("Man005", "Farbmessprotokoll", 0, 1440 + 4.3 * MerkHeight, WholeWidth, 2 * MerkHeight)
      f.Align = FieldAlignEnum.CenterMiddle
      f.Visible = True
      f.Font.Size = 16
      f.Font.Bold = False
      ...
      '
      '
      f = .Fields.Add("Man006", "Messbedingungen", 0.5 * Margin, 1440 + 6.3 * MerkHeight, WholeWidth, 1.5 * MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 12
      f.Font.Bold = True
      ...
      '
      '
      f = .Fields.Add("Man007", "Messgerät:", 0.5 * Margin, 1440 + 8 * MerkHeight, 0.5 * WholeWidth, MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 8.25
      f.Font.Bold = False
      ...
      '
      '
      f = .Fields.Add("Man008", MessGeraet & " (" & MessProg & ")", 0.5 * Margin + 1700, 1440 + 8 * MerkHeight, 0.5 * WholeWidth, MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 8.25
      f.Font.Bold = False
      ...
      '
      '
      f = .Fields.Add("Man009", "Messgeometrie:", 0.5 * Margin, 1440 + 9 * MerkHeight, 0.5 * WholeWidth, MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 8.25
      f.Font.Bold = False
      ...
      '
      '
      f = .Fields.Add("Man010", MessGeometrie, 0.5 * Margin + 1700, 1440 + 9 * MerkHeight, 0.5 * WholeWidth, MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 8.25
      f.Font.Bold = False
      ...
      '
      '
      f = .Fields.Add("Man011", "Farbdifferenzen", 0.5 * Margin, 1440 + 11 * MerkHeight, WholeWidth, 1.5 * MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 12
      f.Font.Bold = True
      ...
      '
      '
      f = .Fields.Add("Man012", "Farbdifferenzformel:", 0.5 * Margin, 1440 + 12.5 * MerkHeight, 0.5 * WholeWidth, MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 8.25
      f.Font.Bold = False
      ...
      '
      '
      f = .Fields.Add("Man013", "CIE L*a*b*", 0.5 * Margin + 1700, 1440 + 12.5 * MerkHeight, 0.5 * WholeWidth, MerkHeight)
      f.Align = FieldAlignEnum.LeftMiddle
      f.Visible = True
      f.Font.Size = 8.25
      f.Font.Bold = False
  ...
  Sub Dosieren(ByVal FarbID() As Integer, ByVal FarbName() As String, ByVal ProNummer() As String, ByVal ProAlt() As Single, ByVal ProNeu() As Single, ByVal ProZuw() As Single)
    ...
    Auftrag = InputBox("Auftragsnummer", "Auftragsnummer eingeben", "")
    '
    '
    '
    '
